  ...
  var lax = function () {
      ...
      for (var i = 0; i < el.attributes.length; i++) {
        ...
        if (bits[1] === "lax") {
          if (a.name === "data-lax-anchor") {
            ...
            (function () {
              var _a$value$split = a.value.split("|"),
                  _a$value$split2 = _slicedToArray(_a$value$split, 2),
                  arrString = _a$value$split2[0],
                  optionString = _a$value$split2[1];
    ...
    lax.updateElement = function (o) {
      ...
      for (var i in transforms) {
        ...
        for (var _i2 in transformData.options) {
          if (_i2 === 'loop') r = r % transformData.options.loop;
        }

        var t = transformFns[i];
        var v = intrp(transformData.valueMap, r);
