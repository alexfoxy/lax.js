...
exports.init = exports.removeElements = exports.removeElement = exports.removeDriver = exports.addElements = exports.addElement = exports.addDriver = exports.laxInstance = void 0;
            ...
            elements.forEach(function (domElement) {
                ...
                domElement.classList.forEach(function (className) {
                    if (className.includes("lax_preset")) {
                        ...
                        if (types_1.isPresetName(preset))
                            presets.push(preset);
                    }
                });
                var transforms = (_a = {},
...
exports.default = lax;
exports.addDriver = lax.addDriver, exports.addElement = lax.addElement, exports.addElements = lax.addElements, exports.removeDriver = lax.removeDriver, exports.removeElement = lax.removeElement, exports.removeElements = lax.removeElements, exports.init = lax.init;
