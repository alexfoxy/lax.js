...
(function () {
  var lax = function () {
    ...
    var toggleClass = function toggleClass(o, n, v) {
      n = n.replace(/.*?:/, '');
      if (v >= 1) o[n] = true;
      if (v <= 0) o[n] = false;
    };
    ...
    lax.createLaxObject = function (el) {
      var classes = el.classList.toString().split(' ').reduce(function (c, e) {
        c[e] = true;
        return c;
      }, {});
      var o = {
    ...
    lax.updateElement = function (o) {
      var originalStyle = o.originalStyle,
          ...
          el = o.el,
          classes = o.classes;
      var r = anchorTop !== undefined ? anchorTop - lastY : lastY;
      var style = {
      ...
      for (var _i5 in transforms) {
        ...
        var c = /:/.test(_i5); // Test if this is a class rule

        if (t) {
          t(style, v);
        } else if (c) {
          toggleClass(classNames, _i5, v);
        } else {// console.info(`lax: error ${i} is not supported`)
        }
      }
