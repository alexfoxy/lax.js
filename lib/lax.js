...
exports.presets = exports.init = exports.removeElements = exports.removeElement = exports.removeDriver = exports.addElements = exports.addElement = exports.addDriver = exports.laxInstance = void 0;
var isPresetName = function (presetName) { return [
    "fadeIn",
    "fadeOut",
    "fadeInOut",
    "scaleIn",
    ...
    function LaxElement(selector, laxInstance, domElement, transformsData, groupIndex, options) {
        ...
        this.calculateTransforms = function () {
            ...
            var _loop_1 = function () {
                ...
                var _a = styleBindings.presets, presets_1 = _a === void 0 ? [] : _a;
                presets_1.forEach(function (presetString) {
                ...
                var _loop_2 = function () {
                    if (key !== "presets") { // should always be true in here, but typescript wants to be 100% sure
                        ...
                        var saveTransform = _this.domElement.style.transform;
                        _this.domElement.style.removeProperty("transform");
                        var bounds_1 = _this.domElement.getBoundingClientRect();
                        _this.domElement.style.transform = saveTransform;
...
exports.laxInstance = new Lax();
var lax = {
    addElements: exports.laxInstance.addElements,
    removeElements: exports.laxInstance.removeElements,
    removeElement: exports.laxInstance.removeElement,
    addElement: exports.laxInstance.addElement,
    init: exports.laxInstance.init,
    addDriver: exports.laxInstance.addDriver,
    removeDriver: exports.laxInstance.removeDriver,
    presets: exports.laxInstance.presets,
};
;
(function () {
...
exports.default = lax;
exports.addDriver = lax.addDriver, exports.addElement = lax.addElement, exports.addElements = lax.addElements, exports.removeDriver = lax.removeDriver, exports.removeElement = lax.removeElement, exports.removeElements = lax.removeElements, exports.init = lax.init, exports.presets = lax.presets;
