System.register("types", [], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_1("cssValues", cssValues);
        }
    };
});
System.register("lax", [], function (exports_2, context_2) {
    "use strict";
    var isPresetName, inOutMap, laxPresets, transformKeys, filterKeys, translate3dKeys, pxUnits, degUnits, easings, LaxDriver, LaxElement, Lax, laxInstance, lax, addDriver, addElement, addElements, removeDriver, removeElement, removeElements, init;
    ...
    function flattenStyles(styles) {
        ...
        Object.keys(styles).forEach(function (key) {
            ...
            if (translate3dKeys.includes(key)) {
                translate3dValues[key] = val; // this was very annoying to get right but I think this should work properly
            }
    ...
    function parseValue(val, _a, index) {
        ...
        if (typeof val === 'string') {
            ...
            return Function("return " + val
                ...
                .replace(/elInY/g, String(top_1 - screenHeight))
                .replace(/elOutY/g, String(bottom))
                .replace(/elCenterY/g, String(top_1 + (height / 2) - (screenHeight / 2)))
    ...
    return {
        setters: [],
        execute: function () {
            isPresetName = function (presetName) { return [
                "fadeIn",
                "fadeOut",
                "fadeInOut",
                "scaleIn",
            ...
            transformKeys = ["perspective", "scaleX", "scaleY", "scale", "skewX", "skewY", "skew", "rotateX", "rotateY", "rotate"];
            filterKeys = ["blur", "hue-rotate", "brightness"];
            translate3dKeys = ["translateX", "translateY", "translateZ"];
            pxUnits = ["perspective", "border-radius", "blur", "translateX", "translateY", "translateZ"];
            degUnits = ["hue-rotate", "rotate", "rotateX", "rotateY", "skew", "skewX", "skewY"];
            easings = {
            ...
            LaxElement = /** @class */ (function () {
                function LaxElement(selector, laxInstance, domElement, transformsData, groupIndex, options) {
                            ...
                            for (key in styleBindings) {
                                if (key !== "presets") {
                                    ...
                                    if (frame % frameStep === 0) {
                                        ...
                                        var interpolatedValue = interpolate(arr1, arr2, v, easingFn); // because this function is only used internally, this casting is valid
                                        if (inertia) {
                                        ...
                                        var dp = unit === 'px' ? 0 : 3;
                                        var val = unit === 'px' ? Number.parseFloat(interpolatedValue.toFixed(dp)) : interpolatedValue;
                    ...
                    this.calculateTransforms = function () {
                        ...
                        var _loop_1 = function () {
                            ...
                            var _loop_2 = function () {
                                if (key !== "presets") { // should always be true in here, but typescript wants to be 100% sure
                                    ...
                                    var bounds_1 = _this.domElement.getBoundingClientRect();
                                    var parsedArr1 = getArrayValues(arr1, windowWidth).map(function (i) { return parseValue(i, bounds_1, _this.groupIndex); }); // should always work here
                                    var parsedArr2 = getArrayValues(arr2, windowWidth).map(function (i) { return parseValue(i, bounds_1, _this.groupIndex); }); // should always work here
                        ...
                        for (driverName in _this.transformsData) {
                            _loop_1();
                        }
                    };
            ...
            exports_2("laxInstance", laxInstance = new Lax());
            lax = {
            ...
            exports_2("default", lax);
            exports_2("addDriver", addDriver = lax.addDriver), exports_2("addElement", addElement = lax.addElement), exports_2("addElements", addElements = lax.addElements), exports_2("removeDriver", removeDriver = lax.removeDriver), exports_2("removeElement", removeElement = lax.removeElement), exports_2("removeElements", removeElements = lax.removeElements), exports_2("init", init = lax.init);
        }
    };
});
